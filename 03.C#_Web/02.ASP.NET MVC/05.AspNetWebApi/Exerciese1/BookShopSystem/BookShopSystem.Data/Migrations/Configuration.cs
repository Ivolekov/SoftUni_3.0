namespace BookShopSystem.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BookShopSystem.Data.BookShopContext>
    {
        ...
        {
            using (var reader = new StreamReader("D:\\MyPrograms\\SoftUni_3.0\\03.C#_Web\\02.C# MVC Frameworks - ASP.NET\\05.AspNetWebApi\\Exerciese1\\BookShopSystem\\resources\\categories.txt"))
            {
        ...
        {
            using (var reader = new StreamReader("D:\\MyPrograms\\SoftUni_3.0\\03.C#_Web\\02.C# MVC Frameworks - ASP.NET\\05.AspNetWebApi\\Exerciese1\\BookShopSystem\\resources\\books.txt"))
            {
                var line = reader.ReadLine();
                line = reader.ReadLine();
                while (line != null)
        ...
        {
            using (var reader = new StreamReader("D:\\MyPrograms\\SoftUni_3.0\\03.C#_Web\\02.C# MVC Frameworks - ASP.NET\\05.AspNetWebApi\\Exerciese1\\BookShopSystem\\resources\\authors.txt"))
            {
                var line = reader.ReadLine();
                line = reader.ReadLine();
                while (line != null)
